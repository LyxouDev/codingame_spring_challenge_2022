"""
    Version : 1.0.0
    ##
    # Adaptation du code de base du challenge afin de mettre en place la structure générale.
    ##
    Ligue : Wood 2
    Tactique :
        Attaquer le monstre le plus près de ma base qui va dans sa direction (simple mais efficace).
"""
